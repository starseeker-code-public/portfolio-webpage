...
function PostCard({ p }: { p: BlogPost }) {
  return (
    <a href={p.url} target="_blank" rel="noopener noreferrer"
      className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4 rounded-xl border border-white/10 bg-slate-900/50 p-4 sm:p-5 hover:border-indigo-700/60 transition-colors group">
      <div>
